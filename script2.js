...
// ═══════════════════════
const marts = [
  { name: 'Wireless Bluetooth Earbuds', price: 1499, category: 'Electronics', img: "images/WirelessBluetoothEarbud.jpg"},
  { name: 'Smartwatch', price: 1999, category: 'Electronics', img: "images/Smartwatch.jpg" },
  { name: 'Bluetooth Speaker', price: 999, category: 'Electronics', img: "images/Bluetooth Speaker.jpg" },
  { name: '32-inch LED TV', price: 14999, category: 'Electronics', img: "images/32-inch LED TV.jpg" },
  { name: 'Laptop Cooling Pad', price: 499, category: 'Electronics', img: "images/Laptop Cooling Pad.jpg" },
  { name: 'Power Bank 20000mAh', price: 1199, category: 'Electronics', img: "images/Power Bank 20000mAh.jpg" },
  { name: 'Wireless Mouse', price: 499, category: 'Electronics', img: "images/Wireless Mouse.jpg"},
  { name: 'Vivo X200 Smartphone 128GB', price: 94999, category: 'Mobiles & Accessories', img: "images/Vivo X200 Smartphone 128GB.jpg" },
  { name: 'Phone Case (Universal)', price: 199, category: 'Mobiles & Accessories', img: "images/Phone Case (Universal).jpg" },
  { name: 'Tempered Glass Screen Protector', price: 99, category: 'Mobiles & Accessories', img: "images/Tempered Glass Screen Protector.jpg" },
  { name: 'Fast Charger 44W', price: 699, category: 'Mobiles & Accessories', img: "images/Fast Charger 44W.jpg" },
  { name: 'USB Type-C Cable', price: 149, category: 'Mobiles & Accessories', img: "images/USB Type-C Cable.jpg" },
  { name: 'Selfie Stick with Tripod', price: 399, category: 'Mobiles & Accessories', img: "images/Selfie Stick with Tripod.jpg" },
  { name: 'Men\'s Cotton T-Shirt', price: 499, category: 'Fashion', img: "images/Men's Cotton T-Shirt.jpg" },
  { name: 'Women\'s Kurti', price: 799, category: 'Fashion', img: "images/Women's Kurti.jpg" },
  { name: 'Men\'s Denim Jeans', price: 1199, category: 'Fashion', img: "images/Men's Denim Jeans.jpg" },
  { name: 'Women\'s Ethnic Saree', price: 1499, category: 'Fashion', img: "images/Women's Ethnic Saree.jpg" },
  { name: 'Men\'s Formal Shirt', price: 499, category: 'Fashion', img: "images/Men's Formal Shirt.jpg" },
  { name: 'Women\'s Casual Dress', price: 999, category: 'Fashion', img: "images/Women's Casual Dress.jpg" },
  { name: 'Kids Winter Jacket', price: 799, category: 'Fashion', img: "images/Kids Winter Jacket.jpg" },
  { name: 'Unisex Hoodie', price: 699, category: 'Fashion', img: "images/Unisex Hoodie.jpg" },
  { name: 'Men\'s Sports Shoes', price: 6999, category: 'Footwear', img: "images/Men's Sports Shoes.jpg" },
  { name: 'Chelsea Boots', price: 899, category: 'Footwear', img: "images/Chelsea Boots.jpg" },
  { name: 'Women\'s Sandals', price: 599, category: 'Footwear', img: "images/Women Sandals.jpg" },
  { name: 'Kids Casual Shoes', price: 399, category: 'Footwear', img: "images/Kids Casual Shoes.jpg" },
  { name: 'Men\'s Formal Shoes', price: 2999, category: 'Footwear', img: "images/Men's Formal Shoes.jpg" },
  { name: 'Women\'s Sneakers', price: 999, category: 'Footwear', img: "images/Women's Sneakers.jpg" },
  { name: 'Non-Stick Cookware Set', price: 1799, category: 'Home & Kitchen', img: "images/Non-Stick Cookware Set.jpg" },
  { name: 'Stainless Steel Water Bottle', price: 449, category: 'Home & Kitchen', img: "images/Stainless Steel Water Bottle.jpg" },
  { name: 'Ceramic Dinner Set (12 pcs)', price: 1499, category: 'Home & Kitchen', img: "images/Ceramic Dinner Set (12 pcs).jpg" },
  { name: 'Electric Kettle', price: 1299, category: 'Home & Kitchen', img: "images/Electric Kettle.jpg" },
  { name: 'Kitchen Knife Set', price: 599, category: 'Home & Kitchen', img: "images/Kitchen Knife Set.jpg" },
  { name: 'Storage Container Set', price: 449, category: 'Home & Kitchen', img: "images/Storage Container Set.jpg" },
  { name: 'Bedsheet Set (Double)', price: 299, category: 'Home & Kitchen', img: "images/Bedsheet Set (Double).jpg" },
  { name: 'Wooden Study Table', price: 2499, category: 'Furniture', img: "images/Wooden Study Table.jpg" },
  { name: 'Folding Chair', price: 799, category: 'Furniture', img: "images/Folding Chair.jpg" },
  { name: 'Office Chair', price: 4500, category: 'Furniture', img: "images/Office Chair.jpg" },
  { name: 'Bookshelf (5-Tier)', price: 1499, category: 'Furniture', img: "images/Bookshelf (5-Tier).jpg" },
  { name: 'Bean Bag Sofa', price: 1299, category: 'Furniture', img: "images/Bean Bag Sofa.jpg" },
  { name: 'Shoe Rack', price: 899, category: 'Furniture', img: "images/Shoe Rack.jpg" },
  { name: 'Face Wash (Neem)', price: 199, category: 'Beauty & Personal Care', img: "images/Neem Face wash.jpg" },
  { name: 'Moisturizing Body Lotion', price: 249, category: 'Beauty & Personal Care', img: "images/Moisturizing Body Lotion.jpg" },
  { name: 'Herbal Shampoo', price: 299, category: 'Beauty & Personal Care', img: "images/Herbal Shampoo.jpg" },
  { name: 'Lipstick Matte', price: 349, category: 'Beauty & Personal Care', img: "images/Lipstick Matte.jpg" },
  { name: 'Electric Trimmer', price: 799, category: 'Beauty & Personal Care', img: "images/Electric Trimmer.jpg" },
  { name: 'Perfume (Eau de Parfum)', price: 899, category: 'Beauty & Personal Care', img: "images/Perfume (Eau de Parfum).jpg" },
  { name: 'Basmati Rice (5kg)', price: 499, category: 'Grocery & Gourmet', img: "images/Basmati Rice (5kg).jpg" },
  { name: 'Toor Dal (1kg)', price: 149, category: 'Grocery & Gourmet', img: "images/Toor Dal (1kg).jpg" },
  { name: 'Cooking Oil (1L)', price: 189, category: 'Grocery & Gourmet', img: "images/Cooking Oil (1L).jpg" },
  { name: 'Green Tea (100 Bags)', price: 249, category: 'Grocery & Gourmet', img: "images/Green Tea (100 Bags).jpg" },
  { name: 'Mixed Dry Fruits (500g)', price: 599, category: 'Grocery & Gourmet', img: "images/Mixed Dry Fruits (500g).jpg" },
  { name: 'Honey (500g)', price: 299, category: 'Grocery & Gourmet', img: "images/Honey (500g).jpg" },
  { name: 'Instant Noodles', price: 199, category: 'Grocery & Gourmet', img: "images/Instant Noodles.jpg" },
  { name: 'Assorted Spices Combo', price: 349, category: 'Grocery & Gourmet', img: "images/Assorted Spices Combo.jpg" },
  { name: 'Bestselling Novel', price: 299, category: 'Books & Stationery', img: "images/Bestselling Novel.jpg" },
  { name: 'Notebook Set (Pack of 5)', price: 199, category: 'Books & Stationery', img: "images/Notebook Set (Pack of 5).jpg" },
  { name: 'Gel Pen Set', price: 95, category: 'Books & Stationery', img: "images/Gel Pen Set.jpg" },
  { name: 'Pencil Set', price: 45, category: 'Books & Stationery', img: "images/Pencil Set.jpg" },
  { name: 'Kids Colouring Book', price: 149, category: 'Books & Stationery', img: "images/Kids Colouring Book.jpg" },
  { name: 'Desk Organizer', price: 349, category: 'Books & Stationery', img: "images/Desk Organizer.jpg" },
  { name: 'Remote Control Car', price: 899, category: 'Toys & Baby Care', img: "images/Remote Control Car.jpg" },
  { name: 'Building Blocks Set', price: 599, category: 'Toys & Baby Care', img: "images/Building Blocks Set.jpg" },
  { name: 'Baby Diapers (Pack of 50)', price: 699, category: 'Toys & Baby Care', img: "images/Baby Diapers (Pack of 50).jpg" },
  { name: 'Baby Feeding Bottle', price: 249, category: 'Toys & Baby Care', img: "images/Baby Feeding Bottle.jpg" },
  { name: 'Soft Plush Teddy Bear', price: 449, category: 'Toys & Baby Care', img: "images/Soft Plush Teddy Bear.jpg" },
  { name: 'Educational Puzzle Set', price: 349, category: 'Toys & Baby Care', img: "images/Educational Puzzle Set.jpg" },
  { name: 'Yoga Mat', price: 499, category: 'Sports & Fitness', img: "images/Yoga Mat.jpg" },
  { name: 'Adjustable Dumbbells Set', price: 1299, category: 'Sports & Fitness', img: "images/Adjustable Dumbbells Set.jpg" },
  { name: 'Skipping Rope', price: 149, category: 'Sports & Fitness', img: "images/Skipping Rope.jpg" },
  { name: 'Football', price: 599, category: 'Sports & Fitness', img: "images/Football.jpg" },
  { name: 'Volley Ball', price: 799, category: 'Sports & Fitness', img: "images/Volley Ball.jpg" },
  { name: 'Basket Ball', price: 899, category: 'Sports & Fitness', img: "images/Basket Ball.jpg" },
  { name: 'Bat (MRF)', price: 1599, category: 'Sports & Fitness', img: "images/Bat MRF.jpg" },
  { name: 'Ball (Cricket)', price: 599, category: 'Sports & Fitness', img: "images/Ball (Cricket).jpg" },
  { name: 'Badminton Racket Set', price: 799, category: 'Sports & Fitness', img: "images/Badminton Racket Set.jpg" },
  { name: 'Fitness Resistance Bands', price: 349, category: 'Sports & Fitness', img: "images/Fitness Resistance Bands.jpg" },
  { name: 'Mixer Grinder (750W)', price: 2199, category: 'Appliances', img: "images/Mixer Grinder (750W).jpg" },
  { name: 'Table Fan', price: 1299, category: 'Appliances', img: "images/Table Fan.jpg" },
  { name: 'Iron Box (Steam)', price: 899, category: 'Appliances', img: "images/Iron Box (Steam).jpg" },
  { name: 'Room Heater', price: 1599, category: 'Appliances', img: "images/Room Heater.jpg" },
  { name: 'Air Fryer', price: 3499, category: 'Appliances', img: "images/Air Fryer.jpg" },
  { name: 'Induction Cooktop', price: 1699, category: 'Appliances', img: "images/Induction Cooktop.jpg" },
  { name: 'AC', price: 59999, category: 'Appliances', img: "images/AC.jpg" },
  { name: 'Cooler', price: 10999, category: 'Appliances', img: "images/Cooler.jpg" },
  { name: 'Aro Water Purifier', price: 9999, category: 'Appliances', img: "images/Aro Water.jpg" },
  { name: 'Digital Thermometer', price: 249, category: 'Health Care', img: "images/Digital Thermometer.jpg" },
  { name: 'Blood Pressure Monitor', price: 1199, category: 'Health Care', img: "images/Blood Pressure Monitor.jpg" },
  { name: 'First Aid Kit', price: 349, category: 'Health Care', img: "images/First Aid Kit.jpg" },
  { name: 'Multivitamin Tablets', price: 399, category: 'Health Care', img: "images/Multivitamin Tablets.jpg" },
  { name: 'Hand Sanitizer (500ml)', price: 149, category: 'Health Care', img: "images/Hand Sanitizer (500ml).jpg" },
  { name: 'Travel Backpack 40L', price: 1499, category: 'Bags & Luggage', img: "images/Travel Backpack 40L.jpg" },
  { name: 'Laptop Bag', price: 899, category: 'Bags & Luggage', img: "images/Laptop Bag.jpg" },
  { name: 'Trolley Suitcase (24-inch)', price: 2499, category: 'Bags & Luggage', img: "images/Trolley Suitcase (24-inch).jpg" },
  { name: 'Women\'s Handbag', price: 799, category: 'Bags & Luggage', img: "images/Women's Handbag.jpg" },
  { name: 'Wallet (Men\'s Leather)', price: 599, category: 'Bags & Luggage', img: "images/Wallet (Men's Leather).jpg" },
  { name: 'Men Leather Belt', price: 799, category: 'Bags & Luggage', img: "images/Leather Belt.jpg" },
];
...
function loadUserHistory() {
  if (currentUser) {
    try {
      orderHistory = JSON.parse(localStorage.getItem("amHistory_" + currentUser.email) || "[]");
    } catch (e) { }
  } else {
    try {
      orderHistory = JSON.parse(localStorage.getItem("amHistory") || "[]");
    } catch (e) { }
  }
}
loadUserHistory();
...
function doSignup() {
  ...
  let users = {};
  try { users = JSON.parse(localStorage.getItem("amUsers") || "{}"); } catch (e) { }
  if (users[email]) { globalErr("signupGlobalErr", "⚠️ Email already registered. Please login."); return; }
 
  users[email] = { name, email, phone, pw };
  try { localStorage.setItem("amUsers", JSON.stringify(users)); } catch (e) { }
...
function payNow() {
  ...
  try {
    const historyKey = currentUser ? "amHistory_" + currentUser.email : "amHistory";
  ...
  overlay.innerHTML = `
    <div style="background:linear-gradient(135deg,#fff0f5,#ffe6f0);border-radius:28px;padding:36px;max-width:380px;width:100%;text-align:center;box-shadow:0 20px 60px rgba(255,51,102,0.3);animation:popIn 0.4s cubic-bezier(0.34,1.56,0.64,1);border:2px solid #ffb3c6;">
      ...
      <p style="font-size:13px;color:#888;margin-bottom:24px;">🕐 Estimated delivery: 2–4 business days</p>
...
function doLogout() {
  ...
  discount = 0;
  updateCount();
  shoppingList.forEach(f => updateCardBadge(f.name));
  loadUserHistory();
  showPage("heroPage");
}
